    ...
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-hero p-8 text-white shadow-glow">
        <div className="relative z-10">
          ...
          <Button variant="hero" size="lg" className="bg-white/20 text-white border border-white/30 hover:bg-white/30">
      ...
      {/* Current Trip */}
      <Card className="shadow-card-custom hover:shadow-travel transition-all duration-300 border-0">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card className="shadow-card-custom hover:shadow-travel transition-all duration-300 cursor-pointer group border-0">
